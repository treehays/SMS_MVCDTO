    ...
    public partial class seeding : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 3, 4, 15, 27, 21, 394, DateTimeKind.Local).AddTicks(253), false, new DateTime(2023, 3, 4, 15, 27, 21, 394, DateTimeKind.Local).AddTicks(275), "Staff", "SuperAdmin" },
                    { 2, new DateTime(2023, 3, 4, 15, 27, 21, 394, DateTimeKind.Local).AddTicks(278), false, new DateTime(2023, 3, 4, 15, 27, 21, 394, DateTimeKind.Local).AddTicks(279), "Staff", "SalesManager" },
                    { 3, new DateTime(2023, 3, 4, 15, 27, 21, 394, DateTimeKind.Local).AddTicks(281), false, new DateTime(2023, 3, 4, 15, 27, 21, 394, DateTimeKind.Local).AddTicks(282), "Staff", "Attendant" },
                    { 4, new DateTime(2023, 3, 4, 15, 27, 21, 394, DateTimeKind.Local).AddTicks(284), false, new DateTime(2023, 3, 4, 15, 27, 21, 394, DateTimeKind.Local).AddTicks(285), "Staff", "Customer" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 3, 4, 15, 27, 21, 394, DateTimeKind.Local).AddTicks(617), "Abdulsuper@gmail.com", "Abdulsuper", true, false, "Salamsuper", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "pass", "08066117783", null, 1, "SUP001" });

            migrationBuilder.InsertData(
                table: "SuperAdmins",
                columns: new[] { "Id", "Created", "DateOfBirth", "Gender", "IsDeleted", "MaritalStatus", "Modified", "UserId" },
                values: new object[] { 1, new DateTime(2023, 3, 4, 15, 27, 21, 394, DateTimeKind.Local).AddTicks(657), new DateTime(2023, 3, 4, 15, 27, 21, 394, DateTimeKind.Local).AddTicks(652), 1, false, 2, new DateTime(2023, 3, 4, 15, 27, 21, 394, DateTimeKind.Local).AddTicks(658), 1 });
