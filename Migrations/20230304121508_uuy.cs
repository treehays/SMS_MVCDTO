...
{
    /// <inheritdoc />
    public partial class uuy : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PicturPath = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsDeleted = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    Modified = table.Column<DateTime>(type: "datetime(6)", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attendants_SalesManagers_SalesManagerID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttendantCustomer", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Attendants_AttendantId",
                        column: x => x.AttendantId,
                        principalTable: "Attendants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Role",
                columns: new[] { "Id", "Created", "IsDeleted", "Modified", "RoleDescription", "RoleName" },
                values: new object[,]
                {
                    { 1, new DateTime(2023, 3, 4, 13, 15, 8, 483, DateTimeKind.Local).AddTicks(801), false, new DateTime(2023, 3, 4, 13, 15, 8, 483, DateTimeKind.Local).AddTicks(812), "Staff", "SuperAdmin" },
                    { 2, new DateTime(2023, 3, 4, 13, 15, 8, 483, DateTimeKind.Local).AddTicks(815), false, new DateTime(2023, 3, 4, 13, 15, 8, 483, DateTimeKind.Local).AddTicks(816), "Staff", "SalesManager" },
                    { 3, new DateTime(2023, 3, 4, 13, 15, 8, 483, DateTimeKind.Local).AddTicks(818), false, new DateTime(2023, 3, 4, 13, 15, 8, 483, DateTimeKind.Local).AddTicks(819), "Staff", "Attendant" },
                    { 4, new DateTime(2023, 3, 4, 13, 15, 8, 483, DateTimeKind.Local).AddTicks(820), false, new DateTime(2023, 3, 4, 13, 15, 8, 483, DateTimeKind.Local).AddTicks(821), "Staff", "Customer" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Created", "Email", "FirstName", "IsActive", "IsDeleted", "LastName", "Modified", "Password", "PhoneNumber", "ProfilePicture", "RoleId", "StaffId" },
                values: new object[] { 1, new DateTime(2023, 3, 4, 13, 15, 8, 483, DateTimeKind.Local).AddTicks(1107), "Abdulsuper@gmail.com", "Abdulsuper", true, false, "Salamsuper", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "pass", "08066117783", null, 1, "SUP001" });

            migrationBuilder.InsertData(
                table: "SuperAdmins",
                columns: new[] { "Id", "Created", "DateOfBirth", "Gender", "IsDeleted", "MaritalStatus", "Modified", "UserId" },
                values: new object[] { 1, new DateTime(2023, 3, 4, 13, 15, 8, 483, DateTimeKind.Local).AddTicks(1136), new DateTime(2023, 3, 4, 13, 15, 8, 483, DateTimeKind.Local).AddTicks(1134), 1, false, 2, new DateTime(2023, 3, 4, 13, 15, 8, 483, DateTimeKind.Local).AddTicks(1137), 1 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendantCustomer_AttendantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendants_SalesManagerID",
                table: "Attendants",
